...
function setup(){
    ...
    redBox = Bodies.rectangle(200,320,100,120,redBox_options);
    ...
    greenBox = Bodies.rectangle(330,320,100,120,greenBox_options);
    ...
    yellowBox = Bodies.rectangle(600,300,100,10,yellowBox_options);
    ...
    ball = Bodies.circle(590,50,20, ball_options);
